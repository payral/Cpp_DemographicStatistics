...
void statTool::computeStatsDemogFinance(Visitor* theRegions, stateGather* fillArrays, 
...
void statTool::computeStatsHospitalFinance(Visitor* theRegions, stateGather* fillArrays, 
